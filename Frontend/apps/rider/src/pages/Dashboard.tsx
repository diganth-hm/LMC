...
import { useRiderStats, useRiderProfile } from '../hooks/useRiderQueries';
    ...
    <div className="min-h-screen bg-[#FBFAF7] pb-20">
          ...
          {statsLoading ? (
            ...
            <>
              <div className="bg-white/15 backdrop-blur-sm rounded-md p-3">
                ...
                <p className="text-xl font-bold text-white">{stats?.todayDeliveries}</p>
              </div>
              <div className="bg-white/15 backdrop-blur-sm rounded-md p-3">
                ...
                <p className="text-xl font-bold text-white">{stats?.todayCO2SavedKg} kg</p>
              </div>
              <div className="bg-white/15 backdrop-blur-sm rounded-md p-3">
                ...
                <p className="text-xl font-bold text-white">₹{stats?.todayEarningsRupees}</p>
              </div>
              <div className="bg-white/15 backdrop-blur-sm rounded-md p-3">
                ...
                <p className="text-xl font-bold text-white">{stats?.grsScore}/100</p>
              </div>
            </>
          )}
        </div>
      ...
      <div className="px-5 mt-6">
        ...
        >
          ...
          <p className="text-sm font-semibold text-gray-900">Machali (Seafood Kitchen)</p>
          <p className="text-xs text-gray-500 mt-0.5">Hampankatta → Kadri Hills · 4.8 km</p>
