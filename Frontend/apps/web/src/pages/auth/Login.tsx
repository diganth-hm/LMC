    ...
    <div className="min-h-screen bg-[#FBFAF7] flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleFormSubmit} className="bg-white rounded-b-lg border border-gray-200 p-6 shadow-sm space-y-4">
          ...
          {/* Demo Credentials Quick Login section */}
          <div className="mt-6 pt-5 border-t border-gray-100">
            ...
            <div className="space-y-2">
              <button
                type="button"
                onClick={() => {
                  setEmail('admin@lastmilecarbon.org');
                  setPassword('admin123');
                  handleRealLogin('admin@lastmilecarbon.org', 'admin123');
                }}
                className="w-full p-2.5 bg-purple-50 hover:bg-purple-100 border border-purple-200 rounded-md text-left transition-colors flex items-center justify-between group"
              >
                <div>
                  <div className="flex items-center gap-1.5">
                    <span className="text-xs font-bold text-purple-900">👑 Platform Admin</span>
                    <span className="text-[10px] bg-purple-200 text-purple-800 px-1.5 py-0.2 rounded">Swiggy Fleet</span>
                  </div>
                  <p className="text-[11px] text-purple-700">admin@lastmilecarbon.org</p>
                </div>
                <span className="text-xs font-semibold text-purple-700 group-hover:translate-x-0.5 transition-transform">Login →</span>
              </button>

              <button
                type="button"
                onClick={() => {
                  setEmail('esg@manipal.edu');
                  setPassword('buyer123');
                  handleRealLogin('esg@manipal.edu', 'buyer123');
                }}
                className="w-full p-2.5 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 rounded-md text-left transition-colors flex items-center justify-between group"
              >
                <div>
                  <div className="flex items-center gap-1.5">
                    <span className="text-xs font-bold text-emerald-900">🏢 Corporate Buyer</span>
                    <span className="text-[10px] bg-emerald-200 text-emerald-800 px-1.5 py-0.2 rounded">Manipal Group</span>
                  </div>
                  <p className="text-[11px] text-emerald-700">esg@manipal.edu</p>
                </div>
                <span className="text-xs font-semibold text-emerald-700 group-hover:translate-x-0.5 transition-transform">Login →</span>
              </button>

              <button
                type="button"
                onClick={() => {
                  setEmail('sustainability@infosys.com');
                  setPassword('buyer123');
                  handleRealLogin('sustainability@infosys.com', 'buyer123');
                }}
                className="w-full p-2.5 bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-md text-left transition-colors flex items-center justify-between group"
              >
                <div>
                  <div className="flex items-center gap-1.5">
                    <span className="text-xs font-bold text-blue-900">🏢 Corporate Buyer</span>
                    <span className="text-[10px] bg-blue-200 text-blue-800 px-1.5 py-0.2 rounded">Infosys ESG</span>
                  </div>
                  <p className="text-[11px] text-blue-700">sustainability@infosys.com</p>
                </div>
                <span className="text-xs font-semibold text-blue-700 group-hover:translate-x-0.5 transition-transform">Login →</span>
              </button>
            </div>
          </div>
        </form>
